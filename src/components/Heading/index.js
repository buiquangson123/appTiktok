...
function Heading() {
    return (
        <div className={clsx(styles.header)}>
            <div className={clsx(styles.headerNav, 'grid', 'wide')}>
                <svg className={clsx(styles.logoImg)} xmlns="http://www.w3.org/2000/svg" width="118" height="42" viewBox="0 0 118 42" fill="none">
                ...
                <div className={clsx(styles.headerSearch)}>
                    <input className={clsx(styles.inputSearch)} placeholder='Tìm kiếm tài khoản và video'/>
                    <button className={clsx(styles.btnSearch)}>
                        <i className={clsx(styles.iconSearch, 'fas', 'fa-search')}></i>
                    </button>
                </div>
                <div className={clsx(styles.headerList)}>
                    <span className={clsx(styles.headerItem, styles.activeDown)}>
                        <i class="iconItem fas fa-cloud-upload-alt"></i>
                    
                        <div className={clsx(styles.downItem)}>
                            <span>Tải video lên</span>
                        </div>
                    </span>
                    <span className={clsx(styles.headerItem, styles.activeMes)}>
                        <i class="iconItem fab fa-telegram-plane"></i>

                        <div className={clsx(styles.mesItem)}>
                            <span>Tin nhắn</span>
                        </div>
                    </span>
                    <span className={clsx(styles.headerItem, styles.activeMail)}>
                        <i class="iconItem fas fa-envelope-open"></i>

                        <div className={clsx(styles.mailItem)}>
                            <span>Hộp thư</span>
                        </div>
                    </span>
                    <span className={clsx(styles.headerItem, styles.activeUser)}>
                        <i class="iconItem fas fa-user-circle"></i>
                        
                        <div className={clsx(styles.userInfor)}>
                            <div className={clsx(styles.userList)}>
                                
                                <a href=" " className={clsx(styles.userItem)}>
