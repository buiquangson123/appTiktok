...
function Heading() {
  return (
    <div className="header">
      <div className="headerNav grid wide">
        <Link to="/">
          <svg
            className="logoImg"
        ...
        <div className="headerList">
          <span className="headerItem activeDown">
            <i className="iconItem fas fa-cloud-upload-alt"></i>

            <div className="downItem">
              <span>Tải video lên</span>
            </div>
          </span>
          <span className="headerItem activeMes">
            <i className="iconItem fab fa-telegram-plane"></i>

            <div className="mesItem">
              <span>Tin nhắn</span>
            </div>
          </span>
          <span className="headerItem activeMail">
            <i className="iconItem fas fa-envelope-open"></i>

            <div className="mailItem">
              <span>Hộp thư</span>
            </div>
          </span>
          <span className="headerItem activeUser">
            <i className="iconItem fas fa-user-circle"></i>

            <div className="userInfor">
              <div className="userList">
                <a href=" " className="userItem">
